...
extension UIViewController {
    ...
    func showAlert(titleAlert: String? = nil, message: String? = nil, style: UIAlertController.Style = .alert, buttons: [(nameButton:String, buttonStyle:UIAlertAction.Style)], completion: @escaping (String) -> () ) {
    ...
    func showAlertWithTextField(titleAlert: String? = nil, message: String? = nil, style: UIAlertController.Style = .alert, completion: @escaping (String) -> ()) {
        let alert = UIAlertController(title: titleAlert, message: message, preferredStyle: style)
